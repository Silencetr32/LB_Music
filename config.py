...
API_ID = int(getenv("API_ID", "21768050"))
API_HASH = getenv("API_HASH", "5f9c4f15b6f8f71298fe65943497cb0d")
...
OWNER_ID = int(getenv("OWNER_ID", "6991310529"))
...
SUPPORT_CHAT = getenv("SUPPORT_GROUP", "https://t.me/SohbetTelegramAilesi")
